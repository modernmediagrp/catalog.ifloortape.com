...
<?php elseif ( 'reveal' == $b['search-layout'] ) : ?>
	...
	#header .searchform .button-wrap { display: flex; align-items: center; position: absolute; <?php echo porto_filter_output( $right ); ?>: 15px; }
	...
	#header .searchform .button-wrap .porto-icon-magnifier::before { content: "\f002"; font-family: "Font Awesome 5 Free"; font-weight: 900; }
<?php elseif ( 'overlay' == $b['search-layout'] ) : ?>
	#header .search-popup .search-toggle { display: inline-block; min-width: 25px; }
	#header .search-popup .searchform { display: flex; position: fixed; top: 100%; z-index: 1003; border-radius: 0; border: none; left: 0; right: 0; height: 100%; margin-top: 0; box-shadow: none; flex-direction: column; justify-content: center; padding-left: var(--porto-column-spacing); padding-right: var(--porto-column-spacing); visibility: hidden; opacity: 0; transition: top 0.3s, visibility 0.3s, opacity 0.3s; }
...
<?php if ( ! empty( $b['sticky-searchform-popup-border-color'] ) && ( 'large' == $b['search-layout'] || 'advanced' == $b['search-layout'] ) ) : ?>
	#header.sticky-header .search-popup .searchform { border-color: <?php echo esc_html( $b['sticky-searchform-popup-border-color'] ); ?>; }
	...
	@media (max-width: 991px) {
		#header.sticky-header .searchform { border-color: <?php echo esc_html( $b['sticky-searchform-popup-border-color'] ); ?>; }
	}
<?php endif; ?>
...
<?php if ( 10 == $header_type ) : ?>
	...
	#header .search-toggle i:before { content: "\f002"; font-family: "Font Awesome 5 Free"; font-weight: 900; }
	@media (max-width: 991px) {
