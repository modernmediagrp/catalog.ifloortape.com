			...
			$general_site_options = array_merge( 
				...
				array(
					array(
						...
						'off'        => __( 'Hide', 'porto' ),
						// 'hint'       => array(
						// 	'content' => esc_html( '<img src="' . PORTO_HINT_URL . 'loading-overlay.gif"/>' ),
						// ),
						// 'customizer' => false,
					),
					array(
						...
						'default'    => false,
						// 'hint'       => array(
						// 	'content' => esc_html( '<img src="' . PORTO_HINT_URL . 'maintenance.jpg"/>' ),
						// ),						
					),
					array(
						'id'       => 'maintenance-page',
					...
					'fields'     => array(
						...
						array(
							...
							'title'  => wp_kses(
								sprintf(
									/* translators: %s: Header Builder url */
									__( 'Header Bottom (It can be overrided by Menu > Menu Styling > Main Menu Wrap options) (Only <a href="%s" class="goto-header-builder">Customize Header Builder</a>.)', 'porto' ),
									esc_url(
										add_query_arg(
											array(
												'autofocus' => array(
				...
				array(
					...
					'fields'     => array(
						...
						array(
							...
							'subtitle' => __( 'Show sidebar toggle button only which leads to the sidebar on the left side of the window.', 'porto' ),
							'default'  => false,
							'on'       => __( 'Yes', 'porto' ),
							'off'      => __( 'No', 'porto' ),
						),
