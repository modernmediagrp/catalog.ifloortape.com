...
DEVSITE="http://catalog.ifloortape.test"

PRODDIR="web@example.com:/srv/www/example.com/shared/uploads/"
PRODSITE="https://ifloortape.com"

STAGDIR="web@catalog.ifloortape.com:/srv/www/catalog.ifloortape.com/shared/uploads/"
STAGSITE="https://catalog.ifloortape.com"
